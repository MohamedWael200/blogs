...
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">Add Post</a>
						</li>
					</ul>
				</div>
			...
			<div class="lefts" style=" background:url('{{asset('adminside/img/pexels-cottonbro-studio-3944463.jpg')}}'); "></div>
                <form  method="POST" action="{{route('store')}}">
                    @csrf
                    <div class="right">
                        <h2>Add Post</h2>
                        <input type="text" class="field" placeholder="Title Of Post" name="title">
                        <textarea placeholder="Content Of Post" class="field" name="contents"></textarea>
